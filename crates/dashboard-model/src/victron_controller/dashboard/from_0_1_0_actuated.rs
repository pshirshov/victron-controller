...
pub fn convert__actuated__from__0_1_0(from: &crate::victron_controller::dashboard::v0_1_0::actuated::Actuated) -> crate::victron_controller::dashboard::actuated::Actuated {
