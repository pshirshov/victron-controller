...
pub fn convert__forecasts__from__0_2_0(from: &crate::victron_controller::dashboard::v0_2_0::forecasts::Forecasts) -> crate::victron_controller::dashboard::forecasts::Forecasts {
    crate::victron_controller::dashboard::forecasts::Forecasts {
