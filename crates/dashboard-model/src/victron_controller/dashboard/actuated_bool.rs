use crate::victron_controller::dashboard::actual_bool::ActualBool;
use crate::victron_controller::dashboard::owner::Owner;
use crate::victron_controller::dashboard::target_phase::TargetPhase;

#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, serde::Serialize, serde::Deserialize)]
pub struct ActuatedBool {
    ...
    pub actual: ActualBool,
}



impl crate::baboon_runtime::BaboonBinCodecIndexed for ActuatedBool {
    fn index_elements_count(_ctx: &crate::baboon_runtime::BaboonCodecContext) -> u16 {
        2
    }
}

impl crate::baboon_runtime::BaboonBinEncode for ActuatedBool {
...
impl crate::baboon_runtime::BaboonBinDecode for ActuatedBool {
    fn decode_ueba(ctx: &crate::baboon_runtime::BaboonCodecContext, reader: &mut dyn std::io::Read) -> Result<Self, Box<dyn std::error::Error>> {
        ...
        let target_value = {
            ...
            if tag == 0 { None } else { Some(crate::baboon_runtime::bin_tools::read_bool(reader)?) }
        };
        ...
        let actual = ActualBool::decode_ueba(ctx, reader)?;
        Ok(ActuatedBool {
            target_value,
            target_owner,
            target_phase,
