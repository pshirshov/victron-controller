use crate::victron_controller::dashboard::v0_2_0::timer::Timer;

#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, serde::Serialize, serde::Deserialize)]
pub struct Timers {
    pub entries: Vec<Timer>,
}



impl crate::baboon_runtime::BaboonBinCodecIndexed for Timers {
    fn index_elements_count(_ctx: &crate::baboon_runtime::BaboonCodecContext) -> u16 {
        1
    }
}

impl crate::baboon_runtime::BaboonBinEncode for Timers {
...
impl crate::baboon_runtime::BaboonBinDecode for Timers {
    fn decode_ueba(ctx: &crate::baboon_runtime::BaboonCodecContext, reader: &mut dyn std::io::Read) -> Result<Self, Box<dyn std::error::Error>> {
        ...
        let entries = {
            ...
            (0..count).map(|_| Ok(Timer::decode_ueba(ctx, reader)?)).collect::<Result<Vec<_>, Box<dyn std::error::Error>>>()?
        };
        Ok(Timers {
            entries,
        })
