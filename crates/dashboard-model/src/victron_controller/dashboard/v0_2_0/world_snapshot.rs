use crate::victron_controller::dashboard::v0_2_0::actuated::Actuated;
use crate::victron_controller::dashboard::v0_2_0::bookkeeping::Bookkeeping;
use crate::victron_controller::dashboard::v0_2_0::cores_state::CoresState;
use crate::victron_controller::dashboard::v0_2_0::decisions::Decisions;
use crate::victron_controller::dashboard::v0_2_0::forecasts::Forecasts;
use crate::victron_controller::dashboard::v0_2_0::knobs::Knobs;
use crate::victron_controller::dashboard::v0_2_0::scheduled_actions::ScheduledActions;
use crate::victron_controller::dashboard::v0_2_0::sensor_meta::SensorMeta;
use crate::victron_controller::dashboard::v0_2_0::sensors::Sensors;
use crate::victron_controller::dashboard::v0_2_0::soc_chart::SocChart;
use crate::victron_controller::dashboard::v0_2_0::timers::Timers;
    ...
    fn encode_ueba(&self, ctx: &crate::baboon_runtime::BaboonCodecContext, writer: &mut dyn std::io::Write) -> std::io::Result<()> {
        ...
        if ctx.use_indices() {
            ...
            }
            {
                let before = buffer.len();
                crate::baboon_runtime::bin_tools::write_i32(writer, before as i32)?;
                value.scheduled_actions.encode_ueba(ctx, &mut buffer)?;
                let after = buffer.len();
                let length = after - before;
                crate::baboon_runtime::bin_tools::write_i32(writer, length as i32)?;
            }
