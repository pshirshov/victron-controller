...
export class SetExtendedChargeMode implements BaboonGenerated {
...
export class SetMode implements BaboonGenerated {
    private readonly _knob_name: string;
...
export class SetBookkeeping implements BaboonGenerated {
