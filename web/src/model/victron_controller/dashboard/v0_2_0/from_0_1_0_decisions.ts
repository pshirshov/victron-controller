...
import {Decisions as v0_2_0_Decisions} from './Decisions'

export function convert__decisions__from__0_1_0(from: v0_1_0_Decisions): v0_2_0_Decisions {
    return new v0_2_0_Decisions (
