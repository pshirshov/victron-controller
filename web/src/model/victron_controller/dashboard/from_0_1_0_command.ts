...
import {Command as dashboard_Command, SetBoolKnob as dashboard_SetBoolKnob, SetFloatKnob as dashboard_SetFloatKnob, SetUintKnob as dashboard_SetUintKnob, SetDischargeTime as dashboard_SetDischargeTime, SetDebugFullCharge as dashboard_SetDebugFullCharge, SetForecastDisagreementStrategy as dashboard_SetForecastDisagreementStrategy, SetChargeBatteryExtendedMode as dashboard_SetChargeBatteryExtendedMode, SetKillSwitch as dashboard_SetKillSwitch} from './Command'

export function convert__command__from__0_1_0(from: v0_1_0_Command): dashboard_Command {
