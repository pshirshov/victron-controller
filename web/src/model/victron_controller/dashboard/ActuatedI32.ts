...
import {ActualI32, ActualI32_UEBACodec} from './ActualI32'
import {TargetPhase, TargetPhase_UEBACodec} from './TargetPhase'
import {Owner, Owner_UEBACodec} from './Owner'

export class ActuatedI32 implements BaboonGeneratedLatest {
    ...
    private readonly _actual: ActualI32;

    constructor(target_value: number | undefined, target_owner: Owner, target_phase: TargetPhase, target_since_epoch_ms: bigint, actual: ActualI32) {
    ...
    public with(overrides: {target_value?: number | undefined; target_owner?: Owner; target_phase?: TargetPhase; target_since_epoch_ms?: bigint; actual?: ActualI32}): ActuatedI32 {
        return new ActuatedI32(
    ...
    public static fromPlain(obj: {target_value: number | undefined; target_owner: Owner; target_phase: TargetPhase; target_since_epoch_ms: bigint; actual: ActualI32}): ActuatedI32 {
        return new ActuatedI32(
            obj.target_value,
            obj.target_owner,
            obj.target_phase,
    ...
    public baboonDomainVersion() {
        return ActuatedI32.BaboonDomainVersion
    }
    public static readonly BaboonDomainIdentifier = 'victron_controller.dashboard'
    public baboonDomainIdentifier() {
        return ActuatedI32.BaboonDomainIdentifier
    }
    public static readonly BaboonTypeIdentifier = 'victron_controller.dashboard/:#ActuatedI32'
    public baboonTypeIdentifier() {
        return ActuatedI32.BaboonTypeIdentifier
    }
    public static readonly BaboonSameInVersions = ["0.1.0"]
    public baboonSameInVersions() {
        return ActuatedI32.BaboonSameInVersions
    }
    public static binCodec(): ActuatedI32_UEBACodec {
        return ActuatedI32_UEBACodec.instance
    }
}

export class ActuatedI32_UEBACodec {
    public encode(ctx: BaboonCodecContext, value: ActuatedI32, writer: BaboonBinWriter): unknown {
        if (this !== ActuatedI32_UEBACodec.lazyInstance.value) {
          return ActuatedI32_UEBACodec.lazyInstance.value.encode(ctx, value, writer)
        }
        ...
        if (ctx === BaboonCodecContext.Indexed) {
            ...
            const buffer = new BaboonBinWriter();
            {
                ...
                BinTools.writeI32(buffer, value.target_value);
            }
            ...
            BinTools.writeI64(buffer, value.target_since_epoch_ms);
            {
                const before = buffer.position();
                BinTools.writeI32(writer, before);
                ActualI32_UEBACodec.instance.encode(ctx, value.actual, buffer);
                const after = buffer.position();
                BinTools.writeI32(writer, after - before);
            }
            ...
            if (value.target_value === undefined) {
                ...
                BinTools.writeI32(writer, value.target_value);
            }
            ...
            ActualI32_UEBACodec.instance.encode(ctx, value.actual, writer);
        }
    }
    
    public decode(ctx: BaboonCodecContext, reader: BaboonBinReader): ActuatedI32 {
        if (this !== ActuatedI32_UEBACodec .lazyInstance.value) {
            return ActuatedI32_UEBACodec.lazyInstance.value.decode(ctx, reader)
        }
        ...
        const target_value = (BinTools.readByte(reader) === 0 ? undefined : BinTools.readI32(reader));
        ...
        const actual = ActualI32_UEBACodec.instance.decode(ctx, reader);
        return new ActuatedI32(
            target_value,
            target_owner,
            target_phase,
    ...
    public static readonly BaboonDomainVersion = '0.1.0'
    public baboonDomainVersion() {
        return ActuatedI32_UEBACodec.BaboonDomainVersion
    }
    public static readonly BaboonDomainIdentifier = 'victron_controller.dashboard'
    public baboonDomainIdentifier() {
        return ActuatedI32_UEBACodec.BaboonDomainIdentifier
    }
    public static readonly BaboonTypeIdentifier = 'victron_controller.dashboard/:#ActuatedI32'
    public baboonTypeIdentifier() {
        return ActuatedI32_UEBACodec.BaboonTypeIdentifier
    }

    protected static lazyInstance = new Lazy(() => new ActuatedI32_UEBACodec())
    public static get instance(): ActuatedI32_UEBACodec {
        return ActuatedI32_UEBACodec.lazyInstance.value
    }
}